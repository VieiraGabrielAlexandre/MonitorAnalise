  ...
  var myobject = null;
	var self = {
		bindings: {
			...
			/**************************************************/
			"movetop": function (t) { self.setWorkingClass(t); _Prtg.objectTools.setObjectPosition.apply(t, [(t.attr('data-id')||t.attr('id')), "top"]); },
			"moveup": function (t) { self.setWorkingClass(t); _Prtg.objectTools.setObjectPosition.apply(t, [(t.attr('data-id')||t.attr('id')), "up"]); },
			"movedown": function (t) { self.setWorkingClass(t); _Prtg.objectTools.setObjectPosition.apply(t, [(t.attr('data-id')||t.attr('id')), "down"]); },
			"movebottom": function (t) { self.setWorkingClass(t); _Prtg.objectTools.setObjectPosition.apply(t, [(t.attr('data-id')||t.attr('id')), "bottom"]); },
			...
			"check": function (t) { self.setWorkingClass(t); _Prtg.objectTools.checkObjectNow.apply(t, [(t.attr('data-id')||t.attr('id'))]); },
			...
			"pauseuntil": function (t) { self.setWorkingClass(t); _Prtg.objectTools.pauseUntil.call(t, (t.attr('data-id')||t.attr('id'))).fail(function(){self.unsetWorkingClass(t);}); },
      		...
      		"maintenance": function (t) { self.setWorkingClass(t); _Prtg.objectTools.setMaintenanceWindow.apply(t, [(t.attr('data-id')||t.attr('id')), "1"]); },
		...
		// SYSTEM MENU ------------------------------------------------------------------------------------------------------------------------------------------------
			...
			{ cls:'system hideforreadonlyuser makemyhomelink', ui:'glyph-home', id:'makehomepage', caption:'<#langjs key="html.menu.Home.MakeThisMyHomepage" default="Make This My Homepage">'},
		...
		// SENSOR MENU ------------------------------------------------------------------------------------------------------------------------------------------------
			{ cls:'sensor menuhead', id:'', caption:'<#langjs key="js.contextmenus.SensorMenu" default="Sensor Menu">'},
			...
			[
				...
				{ cls:'sensor', id:'sensornotifications', ui:'glyph-bell-alt', caption:'<#langjs key="js.contextmenus.Notifications" default="Notifications">&hellip;'},
		...
		// DEVICE MENU ------------------------------------------------------------------------------------------------------------------------------------------------
			{ cls:'device menuhead', id:'', caption:'<#langjs key="js.contextmenus.DeviceMenu" default="Device Menu">'},
			...
			[
				...
				{ cls: 'device', id: 'devicenotifications', ui: 'glyph-bell-alt', caption: '<#langjs key="js.contextmenus.Notifications" default="Notifications">&hellip;' },
				{ cls: 'device', id: 'editaccessrights', ui: 'glyph-lock2', caption: '<#langjs key="js.contextmenus.access" default="Access Rights">&hellip;' },
				{ cls:'device', id:'devicerename', ui:'glyph-doc', caption:'<#langjs key="js.contextmenus.Rename" default="Rename">&hellip;'}
			],
			{ cls:'device hideforreadonlyuser hideforclusterprobe separator', id:'deviceaddsensor', ui:'glyph-plus-circled',  caption:'<#langjs key="js.contextmenus.AddSensor" default="Add Sensor">&hellip;'},
			{ cls:'device hideforreadonlyuser hideforclusterprobe hideforsmallprobe disableifpaused disableifpausedbyparent', ui:'glyph-spin6', id:'', caption:'<#langjs key="js.contextmenus.AutoDiscovery" default="Auto-Discovery">'},
			  [
					{ cls:'device hideforreadonlyuser hideforclusterprobe hideforsmallprobe disableifpaused disableifpausedbyparent', ui:'glyph-spin6', id:'autodiscover', caption:'<#langjs key="js.contextmenus.RunAutoDiscovery" default="Run Auto-Discovery">'},
					{ cls:'device hideforreadonlyuser hideforclusterprobe hideforsmallprobe disableifpaused disableifpausedbyparent', ui:'glyph-spin6', id:'autodiscovertemplate', caption:'<#langjs key="js.contextmenus.RunAutoDiscoveryTemplate" default="Run Auto-Discovery with Template">'}
      	],
			{ cls:'device hideforreadonlyuser hideforclusterprobe hideforsmallprobe', id:'devicecreatetemplate', ui:'glyph-docs', caption:'<#langjs key="js.contextmenus.CreateDeviceTemplate" default="Create Device Template">&hellip;'},
			{ cls:'device hideforreadonlyuser hideforclusterprobe hideforsmallprobe hideforprobedevice hideonpodlocalprobe', id:'recommendnow', ui:'glyph-info-circled', caption:'<#langjs key="js.contextmenus.RecommendNow" default="Recommend Now">'},
		...
		// LIBRARY MENU ------------------------------------------------------------------------------------------------------------------------------------------------
			{ cls:'library menuhead', id:'', caption:'<#langjs key="js.contextmenus.LibraryMenu" default="Library Menu">'},
		...
		// GROUP MENU ------------------------------------------------------------------------------------------------------------------------------------------------
			{ cls:'group menuhead', id:'', caption:'<#langjs key="js.contextmenus.GroupMenu" default="Group Menu">'},
			...
			[
				...
				{ cls:'group', id: 'groupnotifications', ui: 'glyph-bell-alt', caption: '<#langjs key="js.contextmenus.Notifications" default="Notifications">&hellip;' },
				{ cls:'group', id: 'editaccessrights', ui: 'glyph-lock2', caption: '<#langjs key="js.contextmenus.access" default="Access Rights">&hellip;' },
				{ cls:'group', id: 'grouprename', ui:'glyph-doc', caption:'<#langjs key="js.contextmenus.Rename" default="Rename">&hellip;'},
			...
			{ cls:'group hideforreadonlyuser separator', id:'groupaddgroup', ui:'glyph-plus-circled', caption:'<#langjs key="js.contextmenus.AddGroup" default="Add Group">&hellip;'},
			{ cls:'group hideforreadonlyuser hideforsmallprobe hideonpodlocalprobe', id:'groupaddautogroup', ui:'glyph-plus-circled', caption:'<#langjs key="js.contextmenus.AddAutoDiscoveryGroup" default="Add Auto-Discovery Group">&hellip;'},
			{ cls:'group hideforreadonlyuser', id:'groupadddevice', ui:'glyph-plus-circled', caption:'<#langjs key="js.contextmenus.AddDevice" default="Add Device">&hellip;'},
			{ cls:'group autodiscoverable hideforreadonlyuser hideforsmallprobe disableifpaused disableifpausedbyparent hideonpodlocalprobe', id:'', ui:'glyph-binoculars2', caption:'<#langjs key="js.contextmenus.AutoDiscovery" default="Auto-Discovery">'},
      	[
      ...
      { cls:'group hideforreadonlyuser', id:'sortsub', ui:'glyph-sort-name-up', caption:'<#langjs key="js.contextmenus.sortSubObjects" default="Sort Alphabetically">'},
		...
		// ROOTGROUP MENU ------------------------------------------------------------------------------------------------------------------------------------------------
			{ cls:'rootgroup menuhead', id:'', caption:'<#langjs key="js.contextmenus.GroupMenu" default="Group Menu">'},
			...
			[
				...
				{ cls:'rootgroup', id:'rootgroupnotifications', ui:'glyph-bell-alt', caption:'<#langjs key="js.contextmenus.Notifications" default="Notifications">&hellip;'},
				{ cls:'rootgroup', id: 'editaccessrights', ui: 'glyph-lock2', caption: '<#langjs key="js.contextmenus.access" default="Access Rights">&hellip;' },
				{ cls:'rootgroup', id:'rootgrouprename', ui:'glyph-doc', caption:'<#langjs key="js.contextmenus.Rename" default="Rename">&hellip;'},
		...
		// PROBE MENU ------------------------------------------------------------------------------------------------------------------------------------------------
			{ cls:'probe menuhead', id:'', caption:'<#langjs key="js.contextmenus.ProbeMenu" default="Probe Menu">'},
			...
			[
				...
				{ cls:'probe', id: 'probenotifications', ui: 'glyph-bell-alt', caption: '<#langjs key="js.contextmenus.Notifications" default="Notifications">&hellip;' },
				{ cls:'probe', id: 'editaccessrights', ui: 'glyph-lock2', caption: '<#langjs key="js.contextmenus.access" default="Access Rights">&hellip;' },
				{ cls:'probe', id:'proberename', ui:'glyph-doc', caption:'<#langjs key="js.contextmenus.Rename" default="Rename">&hellip;'},
			...
			{ cls:'probe hideforreadonlyuser separator', id:'probeaddgroup', ui:'glyph-plus-circled', caption:'<#langjs key="js.contextmenus.AddGroup" default="Add Group">&hellip;'},
			{ cls:'probe hideforreadonlyuser hideforsmallprobe hideonpodlocalprobe', id:'probeaddautogroup', ui:'glyph-plus-circled', caption:'<#langjs key="js.contextmenus.AddAutoDiscoveryGroup" default="Add Auto-Discovery Group">&hellip;'},
			{ cls:'probe hideforreadonlyuser', id:'probeadddevice', ui:'glyph-plus-circled', caption:'<#langjs key="js.contextmenus.AddDevice" default="Add Device">&hellip;'},
      { cls:'probe hideforreadonlyuser', id:'sortsub', ui:'glyph-sort-name-up', caption:'<#langjs key="js.contextmenus.sortSubObjects" default="Sort Alphabetically">'},
			{ cls:'hideforreadonlyuser allowackuser sensor sensorred hideforclusterprobe', id:'sensoracknowledge', ui:'glyph-ok', caption:'<#langjs key="js.contextmenus.AcknowledgeAlarm" default="Acknowledge Alarm...">'},
			[
				{ cls: 'sensor rootgroup device group probe hideforreadonlyuser allowackuser', id: 'sensoracknowledgenow', ui: 'glyph-ok', caption: '<#langjs key="js.contextmenus.Pause.AcknowledgeIndefinitely" default="Acknowledge Indefinitely">&hellip;' },
				...
				{ cls: 'sensor rootgroup hideforreadonlyuser allowackuser device group probe', id: 'sensoracknowledgeuntil', ui:'glyph-clock', caption: '<#langjs key="js.contextmenus.Pause.until" default="Until">&hellip;' }
			],
			{ cls: 'probe hideiffixed hideforreadonlyuser group device sensor separator disableforlibrary', ui: 'glyph-trash-empty', id: 'dodelete', caption: '<#langjs key="js.contextmenus.Delete" default="Delete">&hellip;' },
			...
			{ cls:'device hideforreadonlyuser', id:'deviceclone', ui:'glyph-docs', caption:'<#langjs key="js.contextmenus.Clone" default="Clone">&hellip;'},
			{ cls:'group hideforreadonlyuser', id:'groupclone', ui:'glyph-docs', caption:'<#langjs key="js.contextmenus.Clone" default="Clone">&hellip;'},
			{ cls:'sensor hideforreadonlyuser', id:'sensorclone', ui:'glyph-docs', caption:'<#langjs key="js.contextmenus.Clone" default="Clone">&hellip;'},

			{ cls: 'sensor hideforreadonlyuser device group probe libraryobject disableforlibrary', id: '', ui: 'glyph-shuffle2', caption: '<#langjs key="js.contextmenus.Move" default="Move">' },
			[
				{ cls: 'sensor hideforreadonlyuser device group probe libraryobject disableforlibrary', id: 'movetop', ui: 'glyph-move-up', caption: '<#langjs key="js.contextmenus.Move.Top" default="Top">' },
				{ cls: 'sensor hideforreadonlyuser device group probe libraryobject disableforlibrary', id: 'moveup', ui: 'glyph-level-up', caption: '<#langjs key="js.contextmenus.Move.Up" default="Up">' },
				{ cls: 'sensor hideforreadonlyuser device group probe libraryobject disableforlibrary', id: 'movedown', ui: 'glyph-level-down', caption: '<#langjs key="js.contextmenus.Move.Down" default="Down">' },
				{ cls: 'sensor hideforreadonlyuser device group probe libraryobject disableforlibrary', id: 'movebottom', ui: 'glyph-move-down', caption: '<#langjs key="js.contextmenus.Move.Bottom" default="Bottom">' },
				{ cls: 'group hideforreadonlyuser separator disableforlibrary', id: 'groupmove', caption: '<#langjs key="js.contextmenus.Move.ToOtherGroup" default="To Other Group">&hellip;' },
				{ cls: 'device hideforreadonlyuser separator disableforlibrary', id: 'devicemove', caption: '<#langjs key="js.contextmenus.Move.ToOtherGroup" default="To Other Group">&hellip;' },
				{ cls: 'group hideforreadonlyuser separator disableforlibrary', id: 'groupmanage', ui: 'glyph-cog2', caption: '<#langjs key="js.contextmenus.manage" default="Management">...' },
				{ cls: 'probe hideforreadonlyuser separator disableforlibrary', id: 'probemanage', ui: 'glyph-cog2', caption: '<#langjs key="js.contextmenus.manage" default="Management">...' }
			],
			{ cls:'sensor hideforreadonlyuser hideifpaused device group rootgroup probe separator', id:'', ui:'glyph-pause3', caption:'<#langjs key="js.contextmenus.Pause" default="Pause">'},
			[
        ...
        { cls:'sensor rootgroup hideforreadonlyuser device group probe separator', id:'maintenance', ui: 'glyph-history', caption:'<#langjs key="js.contextmenus.maintenance" default="One-time Maintenance Window">&hellip;'}
			...
			{ cls:'sensor hideforreadonlyuser disableifpaused disableifpausedbyparent disableiferror disableforsmallprobe', id:'pauseanderror', txt:'‼', caption:'<#langjs key="js.contextmenus.simulateerror" default="Simulate Error Status">'},
			...
			{ cls:'device hideforreadonlyuser sensor separator', id:'', ui:'glyph-star-half-alt', caption:'<#langjs key="js.contextmenus.PriorityFavorite" default="Priority/Favorite">'},
			[
				...
				{ cls:'device hideforreadonlyuser group sensor probe icon-priority-2', id:'prio3', caption:''},
				{ cls:'device hideforreadonlyuser group sensor probe icon-priority-1', id:'prio3', caption:''},
			...
			{ cls:'hideforreadonlyuser group probe separator', id:'', ui:'glyph-star-half-alt', caption:'<#langjs key="js.contextmenus.Priority" default="Priority">'},
				[
					{ cls:'device hideforreadonlyuser group sensor probe icon-priority-5', id:'prio5', caption:''},
					{ cls:'device hideforreadonlyuser group sensor probe icon-priority-4', id:'prio4', caption:''},
					{ cls:'device hideforreadonlyuser group sensor probe icon-priority-3', id:'prio3', caption:''},
			...
			[
				...
				{ cls:'device hideforreadonlyuser hideonpodprobedevice', id:'', ui:'glyph-briefcase2', caption:'<#langjs key="js.contextmenus.Tools2" default="Device Tools">'},
			[
